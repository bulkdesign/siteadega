...
if (fleur_mikado_options()->getOptionValue('mkd_woo_products_list_full_width') == 'yes' && !is_singular('product')) {
	$full_width = true;
}

if ($full_width) { ?>
<div class="mkd-full-width" <?php fleur_mikado_inline_style($background_color); ?>>
	<?php } else { ?>
	<div class="mkd-container" <?php fleur_mikado_inline_style($background_color); ?>>
		<?php }
		if ($full_width) { ?>
		<div class="mkd-full-width-inner" <?php fleur_mikado_inline_style($content_style); ?>>
			<?php } else { ?>
			<div class="mkd-container-inner clearfix" <?php fleur_mikado_inline_style($content_style); ?>>
				<?php }
							...
							<div class="mkd-two-columns-66-33 grid2 mkd-woocommerce-with-sidebar clearfix">
								<div class="mkd-column1">
									<div class="mkd-column-inner">
										<?php if (fleur_mikado_is_woocommerce_installed()) {
											fleur_mikado_woocommerce_content();
										} ?>
									</div>
								</div>
