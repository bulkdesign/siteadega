...
class ProductSlider implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Product Slider', 'fleur'),
			'base'                      => $this->base,
			'category'                  => 'by MIKADO',
			...
			'params'                    => array(
				array(
					"type"        => "dropdown",
					"class"       => "",
					"heading"     => esc_html__('Product type', 'fleur'),
					"param_name"  => "product_type",
					"value"       => array(
						esc_html__('Recent Products', 'fleur')      => 'recent_products',
						esc_html__('Featured Products', 'fleur')    => 'featured_products',
						esc_html__('Products By Id', 'fleur')       => 'products',
						esc_html__('Products By Category', 'fleur') => 'product_category',
						esc_html__('Products On Sale', 'fleur')     => 'sale_products',
						esc_html__('Best Selling', 'fleur')         => 'best_selling_products',
						esc_html__('Top Rated', 'fleur')            => 'top_rated_products'
					),
					"save_always" => true,
					"description" => '',
					'admin_label' => true
				...
				array(
					"type"        => "dropdown",
					"class"       => "",
					"heading"     => esc_html__('Products shown', 'fleur'),
				...
				array(
					...
					"value"       => array(
						...
						esc_html__('ID', 'fleur')            => 'id',
						esc_html__('Author', 'fleur')        => 'author',
						esc_html__('Title', 'fleur')         => 'title',
						esc_html__('Modified', 'fleur')      => 'modified',
						esc_html__('Random', 'fleur')        => 'rand',
						esc_html__('Comment count', 'fleur') => 'comment_count',
						esc_html__('Menu order', 'fleur')    => 'menu_order'
					),
					"description" => "",
					'admin_label' => true,
					"dependency"  => array(
				...
				array(
					"type"        => "dropdown",
					"class"       => "",
					"heading"     => esc_html__('Padding between product items', 'fleur'),
				...
				array(
					...
					"save_value"  => true,
					'admin_label' => true,
					"description" => esc_html__('Number of product on page (-1 is all)', 'fleur')
				),
				array(
					"type"       => "checkbox",
					"class"      => "",
					"heading"    => esc_html__('Prev/Next navigation', 'fleur'),
				...
				array(
					"type"       => "checkbox",
					"class"      => "",
					"heading"    => esc_html__('Bullets navigation', 'fleur'),
				...
				array(
					"type"        => "textfield",
					"class"       => "",
					"heading"     => esc_html__('Products', 'fleur'),
					"param_name"  => "ids",
					"value"       => "",
					"description" => esc_html__('Delimit ID numbers by comma', 'fleur'),
					"dependency"  => array('element' => "product_type", 'value' => array("products"))
				),
				array(
					"type"        => "textfield",
					"class"       => "",
					"heading"     => esc_html__('Category', 'fleur'),
					"param_name"  => "category",
					"value"       => "",
					"description" => esc_html__('Delimit category slugs by comma', 'fleur'),
					'admin_label' => true,
	...
	public function render($atts, $content = null) {
		...
		return fleur_mikado_get_shortcode_module_template_part('templates/product-slider-template', 'product-slider', '', $params);
	}
