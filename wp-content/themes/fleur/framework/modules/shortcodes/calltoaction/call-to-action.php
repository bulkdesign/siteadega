<?php
namespace Fleur\Modules\CallToAction;
...
class CallToAction implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        $call_to_action_button_IconCollections = fleur_mikado_icon_collections()->iconCollections;
        foreach($call_to_action_button_IconCollections as $collection_key => $collection) {

            $call_to_action_button_icons_array[] = array(
                'type'        => 'dropdown',
                'heading'     => esc_html__('Button Icon', 'fleur'),
        ...
        vc_map(array(
            ...
            'params'                    => array_merge(
                array(
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Full Width', 'fleur'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Content in grid', 'fleur'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Grid size', 'fleur'),
                    ...
                    array(
                        ...
                        'value'       => array(
                            ...
                            esc_html__('With Icon', 'fleur') => 'with-icon',
                        ),
                        'save_always' => true,
                        'description' => ''
                    )
                ),
                fleur_mikado_icon_collections()->getVCParamsArray(array(
                    'element' => 'type',
                ...
                array(
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Icon Size (px)', 'fleur'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Box Padding (top right bottom left) px', 'fleur'),
                        'param_name'  => 'box_padding',
                        'admin_label' => true,
                        'description' => esc_html__('Default padding is 20px on all sides', 'fleur'),
                        'group'       => esc_html__('Advanced Options', 'fleur'),
                    ),
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Button Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Button Hover Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Button Hover Background Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Box Background Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Box Border Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Box Border Width (px)', 'fleur'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Default Text Font Size (px)', 'fleur'),
                        'param_name'  => 'text_size',
                        'description' => esc_html__('Font size for p tag', 'fleur'),
                        'group'       => esc_html__('Advanced Options', 'fleur'),
                    ),
                    array(
                        'type'        => 'dropdown',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Type', 'fleur'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Hover Button Type', 'fleur'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Hover Animation', 'fleur'),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Position', 'fleur'),
                        'param_name'  => 'button_position',
                        'value'       => array(
                            esc_html__('Default/right', 'fleur') => '',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Size', 'fleur'),
                        'param_name'  => 'button_size',
                        'value'       => array(
                            esc_html__('Default', 'fleur')     => '',
                            esc_html__('Small', 'fleur')       => 'small',
                            esc_html__('Medium', 'fleur')      => 'medium',
                            esc_html__('Large', 'fleur')       => 'large',
                            esc_html__('Extra Large', 'fleur') => 'big_large'
                        ),
                        'description' => '',
                        'dependency'  => array('element' => 'show_button', 'value' => array('yes')),
                        'group'       => esc_html__('Advanced Options', 'fleur'),
                    ...
                    array(
                        ...
                        'admin_label' => true,
                        'description' => esc_html__('Default text is "button"', 'fleur'),
                        'dependency'  => array('element' => 'show_button', 'value' => array('yes'))
                    ),
                    array(
                        'type'        => 'textfield',
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Button Icon Pack', 'fleur'),
                        'param_name'  => 'button_icon_pack',
                        'value'       => array_merge(array('No Icon' => ''), fleur_mikado_icon_collections()->getIconCollectionsVC()),
                        'save_always' => true,
                        'dependency'  => array('element' => 'show_button', 'value' => array('yes'))
                    )
                ),
    ...
    public function render($atts, $content = null) {
        ...
        $args = array_merge($args, fleur_mikado_icon_collections()->getShortcodeParams(), $call_to_action_icons_form_fields);
        ...
        $html = fleur_mikado_get_shortcode_module_template_part('templates/call-to-action-template', 'calltoaction', '', $params);
    ...
    private function getCallToActionStyles($params) {
        ...
        if($params['box_border_color'] != '') {
            ...
            if($params['box_border_width'] !== '') {
                $border_width = fleur_mikado_filter_px($params['box_border_width']);
            }
    ...
    private function getCallToActionIcon($params) {
        ...
        $icon                                   = fleur_mikado_icon_collections()->getIconCollectionParamNameByKey($params['icon_pack']);
        $iconStyles                             = array();
        $iconStyles['icon_attributes']['style'] = $this->getIconStyles($params);
        $call_to_action_icon                    = '';
        if(!empty($params[$icon])) {
            $call_to_action_icon = fleur_mikado_icon_collections()->renderIcon($params[$icon], $params['icon_pack'], $iconStyles);
        }
    ...
    private function getButtonParameters($params) {
        ...
        if(!empty($params['button_icon_pack'])) {
            ...
            $iconPackName                       = fleur_mikado_icon_collections()->getIconCollectionParamNameByKey($params['button_icon_pack']);
