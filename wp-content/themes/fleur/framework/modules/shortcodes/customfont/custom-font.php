<?php
namespace Fleur\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Custom Font', 'fleur'),
            'base'                      => $this->getBase(),
            'category'                  => 'by MIKADO',
            ...
            'params'                    => array(
                array(
                    "type"       => "dropdown",
                    "heading"    => esc_html__("Custom Font Tag", 'fleur'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Font family", 'fleur'),
                    "param_name" => "font_family",
                    "value"      => ""
                ),
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Font size (px)", 'fleur'),
                    "param_name" => "font_size",
                    "value"      => ""
                ),
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Line height (px)", 'fleur'),
                    "param_name" => "line_height",
                    "value"      => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Font Style", 'fleur'),
                    "param_name"  => "font_style",
                    "value"       => fleur_mikado_get_font_style_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    ...
                    "value"       => array_flip(fleur_mikado_get_font_weight_array()),
                    "save_always" => true
                ),
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Letter Spacing (px)", 'fleur'),
                    "param_name" => "letter_spacing",
                    "value"      => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Text transform", 'fleur'),
                    "param_name"  => "text_transform",
                    "value"       => fleur_mikado_get_text_transform_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Text decoration", 'fleur'),
                    "param_name"  => "text_decoration",
                    "value"       => array(
                        esc_html__('None', 'fleur')         => '',
                        esc_html__('Underline', 'fleur')    => 'underline',
                        esc_html__('Overline', 'fleur')     => 'overline',
                        esc_html__('Line Through', 'fleur') => 'line-through'
                    ),
                    "description" => ""
                ),
                array(
                ...
                array(
                    ...
                    "value"       => array(
                        ...
                        esc_html__('Justify', 'fleur') => 'justify'
                    ),
                    "description" => ""
                ),
                array(
                    ...
                    "value"       => esc_html__('Custom Font Content', 'fleur'),
                    "description" => "",
                    "save_always" => true
                )
            )
    ...
    public function render($atts, $content = null) {
        ...
        $html = fleur_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
