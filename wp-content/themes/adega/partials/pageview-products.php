	        ...
	        <div class="container">
	            ...
	            <div class="tabela">
	                <div class="header-tabela">
	                    <div class="row">
	                        <div class="col-xs-12 col-sm-6 col-md-2 title-produto">Produto</div>
	                        ...
	                        <div class="col-xs-12 col-sm-6 col-md-2 title-print">Orçamento</div>
	                    </div>
	                </div>
