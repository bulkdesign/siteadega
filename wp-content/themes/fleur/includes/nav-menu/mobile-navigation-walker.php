...
if(!class_exists('FleurMikadoMobileNavigationWalker')) {
	class FleurMikadoMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
			...
			if($item->hide == "") {
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="mkd-sub-arrow fa fa-angle-right"></i><i class="fa fa-angle-down"></i></span>';
				}
			}
