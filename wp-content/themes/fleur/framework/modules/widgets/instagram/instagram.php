...
class FleurMikadoInstagramWidget extends FleurMikadoWidget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Mikado Instagram Widget', 'fleur'),
            array('description' => esc_html__('Display instagram images', 'fleur'))
        );
    ...
    protected function setParams() {
        $this->params = array(
            ...
            array(
                'name'  => 'tag',
                'type'  => 'textfield',
                'title' => esc_html__('Tag', 'fleur')
            ),
            array(
                'name'  => 'number_of_photos',
                'type'  => 'textfield',
                'title' => esc_html__('Number of photos', 'fleur')
            ),
            array(
                'name'    => 'number_of_cols',
                'type'    => 'dropdown',
                'title'   => esc_html__('Number of columns', 'fleur'),
                'options' => array(
                    '2' => esc_html__('Two', 'fleur'),
                    '3' => esc_html__('Three', 'fleur'),
                    '4' => esc_html__('Four', 'fleur'),
                    '6' => esc_html__('Six', 'fleur'),
                    '9' => esc_html__('Nine', 'fleur'),
                )
            ),
            array(
                'name'    => 'image_size',
                ...
                'options' => array(
                    'thumbnail'           => esc_html__('Small', 'fleur'),
                    'low_resolution'      => esc_html__('Medium', 'fleur'),
                    'standard_resolution' => esc_html__('Large', 'fleur')
                )
            ),
            array(
                'name'  => 'transient_time',
                'type'  => 'textfield',
                'title' => esc_html__('Images Cache Time', 'fleur')
            ),
        );
    }
