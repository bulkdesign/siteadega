	            ...
	            <div class="panel panel-default">
	                <div class="panel-heading" role="tab" id="heading_<?php echo $a++; ?>">
	                    <h4 class="panel-title">
		                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_<?php echo $e++; ?>" aria-expanded="true" aria-controls="collapse_<?php echo $i++; ?>"><?php the_title() ?><span class="mais">+</span><span class="menos">-</span></a>
	                    </h4>
	                </div>
