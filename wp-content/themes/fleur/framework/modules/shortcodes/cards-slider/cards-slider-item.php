...
class CardsSliderItem implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Cards Slider', 'fleur'),
            'base'                      => $this->base,
            'category'                  => 'by MIKADO',
            ...
            'params'                    => array(
                array(
                    'type'        => 'attach_image',
                    'heading'     => esc_html__('Card Header Image', 'fleur'),
                ...
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Card Background Color', 'fleur'),
                    'param_name'  => 'background_color',
                    'description' => esc_html__('Choose background Color', 'fleur'),
                    'admin_label' => true
                ),
                array(
                    'type'        => 'attach_images',
                    'heading'     => esc_html__('Slider Images', 'fleur'),
                    'param_name'  => 'images',
                    'description' => esc_html__('Choose image from media library', 'fleur'),
                    'admin_label' => true
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Set Middle Slide as Active on Load', 'fleur'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Center Slide', 'fleur'),
                    'param_name'  => 'center_slider',
                    'description' => esc_html__('Set every slide in center of content', 'fleur'),
                    'value'       => array(
                        esc_html__('No', 'fleur')  => 'false',
                        esc_html__('Yes', 'fleur') => 'true'
                    ),
                ...
                array(
                    ...
                    'description' => esc_html__('Show curved edges on every slide', 'fleur'),
                    'value'       => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Hover Animation', 'fleur'),
                    'param_name'  => 'hover_animation',
                    'description' => esc_html__('Show hover animation on every slide', 'fleur'),
                    'value'       => array(
                        esc_html__('No', 'fleur')  => 'no',
                        esc_html__('Yes', 'fleur') => 'yes'
                    ),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Show Navigation Bullets', 'fleur'),
                    'param_name'  => 'show_bullets',
                    'description' => esc_html__('Show navigation bullets under the slider', 'fleur'),
                    'value'       => array(
                        esc_html__('Yes', 'fleur') => 'yes',
                        esc_html__('No', 'fleur')  => 'no'
                    ),
    ...
    public function render($atts, $content = null) {
        ...
        return fleur_mikado_get_shortcode_module_template_part('templates/cards-slider-item-template', 'cards-slider', '', $params);
    }
