...
class HeaderStandard extends HeaderType {
	...
	public function __construct() {
		...
		if (!is_admin()) {
			...
			$menuAreaHeight = fleur_mikado_filter_px(fleur_mikado_options()->getOptionValue('menu_area_height_header_standard'));
	...
	public function headerPerPageStyles($style) {
		...
		$disable_border = fleur_mikado_get_meta_field_intersect('menu_area_border_header_standard', $id) == 'no';
		$disable_grid_border = fleur_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_standard', $id) == 'no';
		$current_style = '';
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters['menu_area_in_grid'] = fleur_mikado_get_meta_field_intersect('menu_area_in_grid_header_standard', $id) == 'yes' ? true : false;
		$parameters['menu_area_position'] = fleur_mikado_get_meta_field_intersect('menu_area_position_header_standard', $id);

		$parameters = apply_filters('fleur_mikado_header_standard_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
		...
		} elseif (fleur_mikado_options()->getOptionValue('menu_area_background_color_header_standard') == '') {
			$menuAreaTransparent = fleur_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
				fleur_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') !== '1';
		} else {
			$menuAreaTransparent = fleur_mikado_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
				fleur_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard') !== '1';
		}
		...
		if ($menuAreaTransparent) {
			...
			if (fleur_mikado_is_top_bar_enabled() && fleur_mikado_is_top_bar_transparent()) {
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if (get_post_meta($id, 'mkd_menu_area_background_color_header_standard_meta', true) !== '') {
			...
			$menuAreaTransparent = fleur_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard') !== '' &&
				fleur_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard') === '0';
		} else {
			$menuAreaTransparent = fleur_mikado_options()->getOptionValue('menu_area_background_color_header_standard') !== '' &&
				fleur_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard') === '0';
		}
