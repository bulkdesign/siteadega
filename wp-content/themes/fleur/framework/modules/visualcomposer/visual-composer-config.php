...
if(!function_exists('fleur_mikado_configure_visual_composer')) {
    /**
     * Configuration for Visual Composer
     * Hooks on vc_after_init action
     */
    function fleur_mikado_configure_visual_composer() {
    ...
    add_action('vc_after_init', 'fleur_mikado_configure_visual_composer');

}


if(!function_exists('fleur_mikado_configure_visual_composer_grid_elemets')) {
    ...
    function fleur_mikado_configure_visual_composer_grid_elemets() {
    ...
    add_action('vc_after_init', 'fleur_mikado_configure_visual_composer_grid_elemets');
}


if(!function_exists('fleur_mikado_configure_visual_composer_frontend_editor')) {
    /**
     * Configuration for Visual Composer FrontEnd Editor
     * Hooks on vc_after_init action
     */
    function fleur_mikado_configure_visual_composer_frontend_editor() {
    ...
    add_action('vc_after_init', 'fleur_mikado_configure_visual_composer_frontend_editor');
}
...
/*** Row ***/
if(!function_exists('fleur_mikado_vc_row_map')) {
    /**
     * Map VC Row shortcode
     * Hooks on vc_after_init action
     */
    function fleur_mikado_vc_row_map() {

        $animations = array(
            esc_html__('No animation', 'fleur')                    => '',
            esc_html__('Elements Shows From Left Side', 'fleur')   => 'mkd-element-from-left',
            esc_html__('Elements Shows From Right Side', 'fleur')  => 'mkd-element-from-right',
            esc_html__('Elements Shows From Top Side', 'fleur')    => 'mkd-element-from-top',
            esc_html__('Elements Shows From Bottom Side', 'fleur') => 'mkd-element-from-bottom',
            esc_html__('Elements Shows From Fade', 'fleur')        => 'mkd-element-from-fade'
        );

        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Row Type', 'fleur'),
            'param_name' => 'row_type',
            'value'      => array(
                esc_html__('Row', 'fleur')           => 'row',
                esc_html__('Parallax', 'fleur')      => 'parallax'
            )
        ));
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Content Width', 'fleur'),
            'param_name' => 'content_width',
            'value'      => array(
                esc_html__('Full Width', 'fleur') => 'full-width',
                esc_html__('In Grid', 'fleur')    => 'grid'
            )
        ));
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Header Style', 'fleur'),
            'param_name' => 'header_style',
            'value'      => array(
                esc_html__('Default', 'fleur') => '',
                esc_html__('Light', 'fleur')   => 'mkd-light-header',
                esc_html__('Dark', 'fleur')    => 'mkd-dark-header'
            ),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Anchor ID', 'fleur'),
            'param_name'  => 'anchor',
            'value'       => '',
            'description' => esc_html__('For example "home"', 'fleur')
        ));
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Content Aligment', 'fleur'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'dropdown',
            'class'       => '',
            'heading'     => esc_html__('Video Background', 'fleur'),
            'value'       => array(
                esc_html__('No', 'fleur')  => '',
                esc_html__('Yes', 'fleur') => 'show_video'
            ),
            'param_name'  => 'video',
            'description' => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'dropdown',
            'class'       => '',
            'heading'     => esc_html__('Video Overlay', 'fleur'),
            'value'       => array(
                esc_html__('No', 'fleur')  => '',
                esc_html__('Yes', 'fleur') => 'show_video_overlay'
            ),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'attach_image',
            'class'       => '',
            'heading'     => esc_html__('Video Overlay Image (pattern)', 'fleur'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Video Background (webm) File URL', 'fleur'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Video Background (mp4) file URL', 'fleur'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'class'       => '',
            'heading'     => esc_html__('Video Background (ogv) file URL', 'fleur'),
            'value'       => '',
        ...
        vc_add_param('vc_row', array(
            'type'        => 'attach_image',
            'class'       => '',
            'heading'     => esc_html__('Video Preview Image', 'fleur'),
            'value'       => '',
        ...
        vc_add_param("vc_row", array(
            'type'        => 'dropdown',
            'class'       => '',
            'heading'     => esc_html__('Full Screen Height', 'fleur'),
        ...
        vc_add_param('vc_row', array(
            'type'       => 'dropdown',
            'class'      => '',
            'heading'    => esc_html__('Vertically Align Content In Middle', 'fleur'),
        ...
        vc_add_param('vc_row', array(
            'type'       => 'textfield',
            'class'      => '',
            'heading'    => esc_html__('Section Height', 'fleur'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'attach_image',
            'class'       => '',
            'heading'     => esc_html__('Parallax Background image', 'fleur'),
            'value'       => '',
            'param_name'  => 'parallax_background_image',
            'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'fleur'),
            'dependency'  => Array('element' => 'row_type', 'value' => array('parallax'))
        ));
        ...
        vc_add_param('vc_row', array(
            'type'       => 'textfield',
            'class'      => '',
            'heading'    => esc_html__('Parallax speed', 'fleur'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('CSS Animation', 'fleur'),
        ...
        vc_add_param('vc_row', array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Transition delay (ms)', 'fleur'),
    ...
    add_action('vc_after_init', 'fleur_mikado_vc_row_map');
}
