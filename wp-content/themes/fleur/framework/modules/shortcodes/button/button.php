...
class Button implements ShortcodeInterface {
        ...
        vc_map(array(
            ...
            'params'                    => array_merge(
                array(
                    array(
                        ...
                        'value'       => array(
                            ...
                            esc_html__('Extra Large', 'fleur')            => 'huge',
                            esc_html__('Extra Large Full Width', 'fleur') => 'huge-full-width'
                        ),
                        'save_always' => true,
                        'admin_label' => true
                    ),
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Hover Type', 'fleur'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Custom CSS class', 'fleur'),
                ...
                array(
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Hover Color', 'fleur'),
    ...
    public function render($atts, $content = null) {
        ...
        return fleur_mikado_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', '', $params);
    }
