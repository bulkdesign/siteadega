<?php
namespace Fleur\Modules\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Pie Chart With Icon', 'fleur'),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array_merge(
                array(
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Percentage', 'fleur'),
                        'param_name'  => 'percent',
                        'description' => '',
                        'admin_label' => true
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Size(px)', 'fleur'),
                        'param_name'  => 'size',
                        'description' => '',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Active Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Inactive Color', 'fleur'),
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Margin below chart (px)', 'fleur'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = fleur_mikado_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
    ...
    private function getPieChartIcon($params) {
        ...
        $pie_chart_icon = fleur_mikado_icon_collections()->renderIcon($params[$icon], $params['icon_pack'], $iconStyles);
