...
class ProcessHolder implements ShortcodeInterface {
        ...
        vc_map(array(
            ...
            'params'                  => array(
                array(
                    ...
                    'heading'     => esc_html__('Number of Process Items', 'fleur'),
                    'value'       => array(
                        esc_html__('Three', 'fleur') => 'three',
                        esc_html__('Four', 'fleur')  => 'four'
                    ),
                    'save_always' => true,
                    'admin_label' => true,
                    'description' => ''
    ...
    public function render($atts, $content = null) {
        ...
        return fleur_mikado_get_shortcode_module_template_part('templates/process-holder-template', 'process', '', $params);
    }
}