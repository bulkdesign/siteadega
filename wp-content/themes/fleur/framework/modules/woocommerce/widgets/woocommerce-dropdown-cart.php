...
class FleurMikadoWoocommerceDropdownCart extends WP_Widget {
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Mikado Woocommerce Dropdown Cart', 'fleur'), // Name
            array('description' => esc_html__('Mikado Woocommerce Dropdown Cart', 'fleur'),) // Args
        );
    }
                    ...
                    <div class="mkd-shopping-cart-dropdown">
                        ...
                        <ul>
                            ...
                            <?php if(!$cart_is_empty) : ?>
                                        ...
                                        <div class="mkd-item-info-holder">
                                            <div class="mkd-item-left">
                                                ...
                                                <span class="mkd-quantity"><?php echo esc_html($cart_item['quantity']);
                                                    esc_html_e(' x ', 'fleur'); ?><?php echo apply_filters('woocommerce_cart_item_price_html', wc_price($product_price), $cart_item, $cart_item_key); ?></span>
                                            </div>
                                            <div class="mkd-item-right">
                                                <?php echo apply_filters('woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', esc_url($woocommerce->cart->get_remove_url($cart_item_key)), esc_html__('Remove this item', 'fleur')), $cart_item_key); ?>
                                ...
                                <div class="mkd-cart-bottom">
                                    <div class="mkd-subtotal-holder clearfix">
                                        <span class="mkd-total"><?php esc_html_e('Total', 'fleur'); ?>:</span>
                                    ...
                                    <div class="mkd-btns-holder clearfix">
                                        ...
                                        <?php echo fleur_mikado_get_button_html(array(
                                            ...
                                            'text'         => esc_html__('View Cart', 'fleur'),
                                            'size'         => 'small',
                                            'type'         => 'solid'
                                        )); ?>
                                    </div>
                            ...
                            <?php else : ?>
                                ...
                                <li class="mkd-empty-cart"><?php esc_html_e('No products in the cart.', 'fleur'); ?></li>
...
add_action('widgets_init', create_function('', 'register_widget( "FleurMikadoWoocommerceDropdownCart" );'));
?>
<?php
add_filter('add_to_cart_fragments', 'fleur_mikado_woocommerce_header_add_to_cart_fragment');
