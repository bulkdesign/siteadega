...
class FleurMikadoIconsFontElegant implements iFleurMikadoIconCollection {
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="mkd-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
