	...
	<div class="mkd-iwt-icon-holder">
		...
		<?php else: ?>
			...
			if($icon_parameters['icon_pack']) {
				echo fleur_mikado_get_shortcode_module_template_part('templates/icon', 'icon-with-text', '', array('icon_parameters' => $icon_parameters));
			}
			?>
		<?php endif; ?>
	</div>
	...
	<div class="mkd-iwt-text-holder">
		...
		<?php if (!empty($link) && !empty($link_text)) : ?>
			<a class="mkd-iwt-link"
			   href="<?php echo esc_attr($link); ?>" <?php fleur_mikado_inline_attr($target, 'target'); ?>><?php echo esc_html($link_text); ?></a>
		<?php endif; ?>
	</div>
</div>
</div>