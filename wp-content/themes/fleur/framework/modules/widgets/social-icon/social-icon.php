...
class FleurMikadoSocialIconWidget extends FleurMikadoWidget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Mikado Social Icon Widget', 'fleur') // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            ...
            array(
                ...
                array(
                    'type'        => 'textfield',
                    'title'       => esc_html__('Text Size (px)', 'fleur'),
                    'name'        => 'text_size',
                    'description' => ''
                ),
                array(
                ...
                array(
                    'type'        => 'textfield',
                    'title'       => esc_html__('Hover Color', 'fleur'),
                    'name'        => 'hover_color',
                    'description' => ''
                ),
                array(
                    'type'        => 'textfield',
                    'title'       => esc_html__('Margin', 'fleur'),
                    'name'        => 'margin',
    ...
    public function widget($args, $instance) {
        ...
        <a class="mkd-social-icon-widget-holder" <?php echo fleur_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php fleur_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
