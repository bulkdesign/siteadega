...
class LFB_admin {
    ...
    public function view_edit_lfb() {
        ...
        echo '<th style="width: 238px;">' . __('Actions', 'lfb') . '</th>';
        echo '</thead>';
        echo '<tbody>';
        echo '</tbody>';
        echo '</table>';
...
//        ' . wp_editor('<p>Ref: <strong>[ref]</strong></p><h2 style="color: #008080;">Information</h2><hr/><span style="font-weight: 600; color: #444444;">[information_content]</span><span style="color: #444444;"> </span><hr/><h2 style="color: #008080;">Project</h2><hr/>[project_content]<hr/><h4>Total: <strong><span style="color: #444444;">[total_price]</span></strong></h4>', 'email_adminContent', array('tinymce' => array('height' => 300))) . '
    ...
    ';
        ...
        echo '           <div class="col-md-12" id="lfb_finalStepFields" >
                            ...
                            <p style="text-align: left;" ><a href="javascript:" id="lfb_addFieldBtn" onclick="lfb_editItem(0);" class="btn btn-primary" ><span class="glyphicon glyphicon-plus" ></span>' . __('Add a field', 'lfb') . ' </a></p>
                              ...
                              <div class="form-group" >
                                 ...
                                 <div class="form-group" >
                                    <label> ' . __('Style of fields', 'lfb') . ' </label >
                                     <select type="number" name="fieldsPreset" class="form-control" style="width: 100%;">
 ...
 <small>' . __('A pdf file will be generated and sent as attachment', 'lfb') . '</small>
        ...
        echo '<div class="form-group" >
                    ...
                    <select name="type" class="form-control">
                        ...
                        <option value="timepicker">' . __('Time picker', 'lfb') . '</option>               
                    </select>
...
if(([item-3_quantity] >5) ) {
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               ...
                               <p style="clear: both; text-align: center; margin: 0px; margin-top:12px;"><a href="https://youtu.be/sCxV7CdTcrQ" target="_blank" class="btn btn-info"><span class="glyphicon glyphicon-play-circle"></span>' . __('See Form Designer in action', 'lfb') . '</a></p>
                                ...
                                <p style="text-align: center">' . __('If you need to buy a new license of this plugin', 'lfb') . ', <a href="https://codecanyon.net/item/wp-flat-estimation-payment-forms-/7818230?ref=loopus" target="_blank">' . __('click here', 'lfb') . '</a>.</p>
                                </div>
                                </div>
        ...
        echo '<div id="lfb_winDeleteForm" class="modal fade">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                               <div class="alert alert-danger"><p style="text-align: center;">' . __('Are you sure you want to delete the form', 'lfb') . ' <strong id="lfb_deleteFormTitle"></strong> ?</p></div>
    ...
    private function lfb_generatePdfCustomer($order) {
        ...
        $html2pdf->Output($this->parent->dir . '/uploads/' . $fileName, 'F');
    ...
    function saveLog() {
        if (current_user_can('manage_options')) {
            ...
            $table_name = $wpdb->prefix . "wpefc_logs";
            $wpdb->update($table_name, array('content' => $content, 'contentUser' => $content), array('id' => $logID));
            die();
        }
    }
    /* Load Logs */
    function loadLogs() {
        if (current_user_can('manage_options')) {
            ...
            foreach ($logs as $log) {
                $formTitle = "";
                $rep .= '<tr data-logid="' . $log->id . '" data-useremail="' . $log->email . '">
    ...
    function admin_styles() {
        if (isset($_GET['page']) && strpos($_GET['page'], 'lfb') !== false) {
            ...
            wp_register_style($this->parent->_token . '-bootstrap-timepicker', esc_url($this->parent->assets_url) . 'css/timepicker.min.css', array(), $this->parent->_version);
    ...
    function admin_scripts() {
        if (isset($_GET['page']) && strpos($_GET['page'], 'lfb') !== false) {
            ...
            wp_register_script($this->parent->_token . '-bootstrap-timepicker', esc_url($this->parent->assets_url) . 'js/bootstrap-timepicker.min.js', array($this->parent->_token . '-bootstrap'), $this->parent->_version);
