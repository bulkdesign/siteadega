...
class Accordion implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                    => esc_html__('Accordion', 'fleur'),
            'base'                    => $this->base,
            ...
            'params'                  => array(
                ...
                array(
                    ...
                    'param_name'  => 'style',
                    'value'       => array(
                        esc_html__('Accordion', 'fleur')       => 'accordion',
                        esc_html__('Boxed Accordion', 'fleur') => 'boxed_accordion',
                        esc_html__('Toggle', 'fleur')          => 'toggle',
                        esc_html__('Boxed Toggle', 'fleur')    => 'boxed_toggle'
                    ),
                    'save_always' => true,
                    'description' => ''
                )
    ...
    public function render($atts, $content = null) {
        ...
        $output .= fleur_mikado_get_shortcode_module_template_part('templates/accordion-holder-template', 'accordions', '', $params);
