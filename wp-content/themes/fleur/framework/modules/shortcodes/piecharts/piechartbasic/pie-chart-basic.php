...
class PieChartBasic implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Pie Chart', 'fleur'),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array(
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Type of Central text', 'fleur'),
                    'param_name'  => 'type_of_central_text',
                    'value'       => array(
                        esc_html__('Percent', 'fleur') => 'percent',
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Typography Style', 'fleur'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = fleur_mikado_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
