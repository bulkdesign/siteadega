<li <?php post_class('mkd-blog-list-item mkd-blog-list-masonry-item clearfix'); ?>>
	<div class="mkd-blog-list-item-inner">
		<?php if(!$hide_image) : ?>
			<div class="mkd-item-image">
				<a href="<?php echo esc_url(get_permalink()) ?>">
					<?php if($use_custom_image_size) : ?>
						<?php echo fleur_mikado_generate_thumbnail(
		...
		<div class="mkd-post-item-author-holder">
			<a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>">
					...
					<span class="mkd-post-item-author-avatar-holder">
						<?php echo fleur_mikado_kses_img(get_avatar(get_the_author_meta('ID'), 30)); ?>
					</span>
