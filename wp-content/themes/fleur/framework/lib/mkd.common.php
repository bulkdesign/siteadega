...
$fleur_options_fontstyle     = array(
	"normal" => "normal",
	"italic" => "italic"
);
$fleur_options_fontweight    = array(
	"100" => "100",
	"200" => "200",
	"300" => "300",
	"400" => "400",
...
$fleur_options_texttransform = array(
	"none"       => "None",
...
$fleur_options_fontdecoration = array(
	"none"      => "none",
	"underline" => "underline"
);

$fleur_options_arrows_type = array(
...
$fleur_options_double_arrows_type = array(
	'fa fa-angle-double-'          => 'fa-angle-double',
	'arrow_carrot-2'               => 'arrow_carrot-2',
	'arrow_carrot-2left_alt2'      => 'arrow_carrot 2 alt2',
	'icon-arrows-left-double-32'   => 'icon-arrows double',
...
$fleur_options_arrows_up_type = array(
