 ...
 */
?>
<div <?php fleur_mikado_class_attribute($holder_classes); ?> <?php echo fleur_mikado_get_inline_attrs($data_attr); ?>>

	<div class="mkd-percentage" <?php echo fleur_mikado_get_inline_attrs($pie_chart_data); ?>>
