...
class PieChartDoughnut implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Pie Chart 3 (Doughnut)', 'fleur'),
            'base'                      => $this->getBase(),
            'category'                  => 'by MIKADO',
    ...
    public function render($atts, $content = null) {
        ...
        $html = fleur_mikado_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
