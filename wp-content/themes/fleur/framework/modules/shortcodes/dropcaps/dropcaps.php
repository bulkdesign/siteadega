<?php
namespace Fleur\Modules\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = fleur_mikado_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
	...
	private function getDropcapsClass($params) {
		return ($params['type'] !== '') ? 'mkd-'.$params['type'] : '';
	}
}