...
class TeamSlider implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'         => esc_html__('Team Slider', 'fleur'),
            'base'         => $this->base,
            'category'     => 'by MIKADO',
            ...
            'params'       => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Number of Items in Row', 'fleur'),
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Enable AutoPlay?', 'fleur'),
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Enable Pagination?', 'fleur'),
    ...
    public function render($atts, $content = null) {
        ...
        return fleur_mikado_get_shortcode_module_template_part('templates/team-slider-template', 'team-slider', '', $params);
    }
