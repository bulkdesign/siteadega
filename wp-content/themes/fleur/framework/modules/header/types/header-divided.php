...
class HeaderDivided extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = fleur_mikado_filter_px(fleur_mikado_options()->getOptionValue('menu_area_height_header_divided'));
    ...
    public function headerPerPageStyles($style) {
        ...
        $disable_border = fleur_mikado_get_meta_field_intersect('menu_area_border_header_divided',$id) == 'no';
        $disable_grid_border = fleur_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_divided',$id) == 'no';
		$current_style = '';
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = fleur_mikado_get_meta_field_intersect('menu_area_in_grid_header_divided',$id) == 'yes' ? true : false;

        $parameters = apply_filters('fleur_mikado_header_divided_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (fleur_mikado_options()->getOptionValue('menu_area_background_transparency_header_divided') !== '1' && fleur_mikado_options()->getOptionValue('menu_area_background_transparency_header_divided') !== '') {
            $menuAreaTransparent = true;
        } else if (is_404() && fleur_mikado_options()->getOptionValue('404_menu_area_background_transparency_header') !== '1' && fleur_mikado_options()->getOptionValue('404_menu_area_background_transparency_header') !== '') {
            $menuAreaTransparent = true;
        } else {
        ...
        if($menuAreaTransparent) {
            ...
            if(fleur_mikado_is_top_bar_enabled() || fleur_mikado_is_top_bar_enabled() && fleur_mikado_is_top_bar_transparent()) {
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        $menuAreaTransparent = fleur_mikado_options()->getOptionValue('fixed_header_transparency') === '0';
    ...
    public function getPerPageJSVariables($perPageVars) {
        ...
        if(!in_array(fleur_mikado_options()->getOptionValue('header_behaviour'), array('sticky-header-on-scroll-up','sticky-header-on-scroll-down-up'))) {
