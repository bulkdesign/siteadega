        ...
        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]  #mainPanel .genSlide .lfb_timepicker').each(function () {
            ...
            jQuery(this).timepicker().on('changeTime.timepicker', function (e) {
                ...
                if (minTime != "" && minTime.indexOf(':') > 0) {
                    ...
                    if (e.time.hours < minHour || (e.time.hours == minHour && e.time.minutes < minMins)) {
                        jQuery(this).val('');
                    }
                }
                if (maxTime != "" && maxTime.indexOf(':') > 0) {
                    ...
                    if (e.time.hours > maxHour || (e.time.hours == maxHour && e.time.minutes > maxMins)) {
                        jQuery(this).val('');
                    }
                }
            });
        ...
        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]  #mainPanel .genSlide .lfb_datepicker').each(function () {
            ...
            jQuery(this).datepicker({
                ...
                onClose: function (dateText, inst) {
                    ...
                    jQuery(this).closest('.form-group').removeClass('lfb_focus');
                },
                beforeShow: function (textbox, instance) {
                    jQuery(this).attr("disabled", true);
                    jQuery(this).closest('.form-group').addClass('lfb_focus');
                    jQuery(this).blur();
                    jQuery('#ui-datepicker-div').addClass('lfb_datepickerContainer');
                    if (parseInt(jQuery(this).attr('data-showmonths')) == 1 || parseInt(jQuery(this).attr('data-showmonths')) == 1) {
                        jQuery('#ui-datepicker-div').addClass('lfb_datepickerHasMenu');
                    }
                },
                minDate: minDate,
            ...
            if ($item.is('.lfb_disabled') || $item.closest('.genSlide').is('.lfb_disabled')) {
                ...
                if (condition.value && condition.value.indexOf('_') > -1) {
                    if (condition.value.substr(0, 1) != '_') {
                        ...
                        if (condition.value == '_total') {
                            condition.value = form.price;
                        } else if (condition.value == '_total_qt') {
                            condition.value = wpe_getTotalQuantities(formID);
                        }
                    }
        ...
        if ((step == 'final' || parseInt(step) != 0) && !jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #mainPanel .genSlide[data-stepid="' + step + '"]').is('.lfb_disabled')) {
            ...
            $panel.find('div.selectable.checked, input[type=checkbox]:checked,select[data-itemid][data-price],div[data-type="slider"]').each(function () {
                if (!jQuery(this).is('.lfb_disabled') && jQuery(this).closest('.itemBloc.lfb_disabled').length == 0) {
                    if (/*(step == 'final' || jQuery.inArray(parseInt($panel.attr('data-stepid')), lastAndCurrentSteps) >= 0)*/  !jQuery(this).is('.lfb_disabled')) {
