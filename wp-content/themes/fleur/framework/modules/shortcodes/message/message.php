<?php
namespace Fleur\Modules\Message;
...
class Message implements ShortcodeInterface {
				...
				array(
					array(
						...
						'value'       => array(
							...
							esc_html__('With Icon', 'fleur') => 'with_icon'
						),
						'save_always' => true
					)
				),
				\FleurMikadoIconCollections::get_instance()->getVCParamsArray(array(
					'element' => 'type',
					'value'   => 'with_icon'
				)),
				array(
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Border Width (px)', 'fleur'),
						'param_name'  => 'border_width',
						'description' => esc_html__('Default value is 0', 'fleur')
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color', 'fleur'),
	...
	public function render($atts, $content = null) {
		...
		$html = fleur_mikado_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);
