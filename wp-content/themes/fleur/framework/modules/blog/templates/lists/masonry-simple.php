<?php fleur_mikado_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
	<div class="mkd-blog-holder mkd-blog-type-masonry mkd-masonry-full-width mkd-masonry-simple mkd-masonry-pagination-<?php echo fleur_mikado_options()->getOptionValue('masonry_pagination'); ?>">
