...
add_action('after_setup_theme', 'fleur_mikado_admin_map_init', 0);

function fleur_mikado_admin_map_init() {

	do_action('fleur_mikado_before_options_map');
	...
	do_action('fleur_mikado_options_map');

	do_action('fleur_mikado_after_options_map');
