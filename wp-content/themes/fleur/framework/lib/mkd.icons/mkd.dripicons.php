...
/**
 * Class FleurMikadoDripicons
 */
class FleurMikadoDripicons implements iFleurMikadoIconCollection {
    /**
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="mkd-icon-dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
