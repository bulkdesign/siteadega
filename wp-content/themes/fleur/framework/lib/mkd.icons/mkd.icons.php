...
/*
  Class: FleurMikadoIconCollections
...
class FleurMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new FleurMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new FleurMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new FleurMikadoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new FleurMikadoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new FleurMikadoLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new FleurMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new FleurMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getSocialVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false, $exclude = '') {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon pack', 'fleur'),
    ...
    public function getWidgetIconParams() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'fleur'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome'      => esc_html__('Font Awesome', 'fleur'),
                'font_elegant'      => esc_html__('Font Elegant', 'fleur'),
                'ion_icons'         => esc_html__('Ion Icons', 'fleur'),
                'simple_line_icons' => esc_html__('Simple Line Icons', 'fleur')
            )
        );
    ...
    public function getIconCollectionIcons(iFleurMikadoIconCollection $collection) {
...
$fleur_IconCollections = FleurMikadoIconCollections::get_instance();